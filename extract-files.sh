...
function blob_fixup() {
    case "${1}" in
        vendor/etc/media_codecs_kona.xml)
            ...
            ;;
        vendor/lib64/libdlbdsservice.so | vendor/lib/libstagefright_soft_ac4dec.so | vendor/lib/libstagefright_soft_ddpdec.so | vendor/lib64/libstagefright_soft_ac4dec.so | vendor/lib64/libstagefright_soft_ddpdec.so)
